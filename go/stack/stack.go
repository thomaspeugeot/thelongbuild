...
import (
	...
	"github.com/thomaspeugeot/thelongbuild/go/fullstack"
	"github.com/thomaspeugeot/thelongbuild/go/models"
	"github.com/thomaspeugeot/thelongbuild/go/orm"
	"github.com/thomaspeugeot/thelongbuild/go/probe"

	thelongbuild_go "github.com/thomaspeugeot/thelongbuild/go"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.StageStruct) {
	...
	stage.Checkout()
	stage.Marshall(file, "github.com/thomaspeugeot/thelongbuild/go/models", "main")
}
...
func NewStack(
	...
	if withProbe {
		stack.Probe = probe.NewProbe(r, thelongbuild_go.GoModelsDir, thelongbuild_go.GoDiagramsDir,
