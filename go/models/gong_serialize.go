...
func SerializeStage(stage *StageStruct, filename string) {
	...
	{
		// insertion point
		SerializeExcelize[AWitch](stage, f)
		SerializeExcelize[BlackKnightShape](stage, f)
		SerializeExcelize[BringYourDead](stage, f)
		SerializeExcelize[Document](stage, f)
		SerializeExcelize[DocumentUse](stage, f)
		SerializeExcelize[GalahadThePure](stage, f)
		SerializeExcelize[GeoObject](stage, f)
		SerializeExcelize[GeoObjectUse](stage, f)
		SerializeExcelize[Group](stage, f)
		SerializeExcelize[GroupUse](stage, f)
		SerializeExcelize[KingArthur](stage, f)
		SerializeExcelize[KingArthurShape](stage, f)
		SerializeExcelize[KnightWhoSayNi](stage, f)
		SerializeExcelize[Lancelot](stage, f)
		SerializeExcelize[LancelotAgregation](stage, f)
		SerializeExcelize[LancelotAgregationUse](stage, f)
		SerializeExcelize[LancelotCategory](stage, f)
		SerializeExcelize[LancelotCategoryUse](stage, f)
		SerializeExcelize[MapObject](stage, f)
		SerializeExcelize[MapObjectUse](stage, f)
		SerializeExcelize[Repository](stage, f)
		SerializeExcelize[SirRobin](stage, f)
		SerializeExcelize[TheBridge](stage, f)
		SerializeExcelize[TheNuteShape](stage, f)
		SerializeExcelize[TheNuteTransition](stage, f)
		SerializeExcelize[User](stage, f)
		SerializeExcelize[UserUse](stage, f)
		SerializeExcelize[WhatIsYourPreferedColor](stage, f)
		SerializeExcelize[Workspace](stage, f)
	}
