...
import (
	...
	thelongbuild_orm "github.com/thomaspeugeot/thelongbuild/go/orm"
...
type Controller struct {
	...
	Map_BackRepos map[string]*thelongbuild_orm.BackRepoStruct
}
...
func GetController() *Controller {
	doControllerInitOnce.Do(func() {
		_controllerSingloton = &Controller{
			Map_BackRepos: make(map[string]*thelongbuild_orm.BackRepoStruct),
		}
	})
	return _controllerSingloton
}

func (controller *Controller) AddBackRepo(backRepo *thelongbuild_orm.BackRepoStruct, stackPath string) {
