...
import (
	...
	"github.com/thomaspeugeot/thelongbuild"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(thelongbuild.NgDistNg, "ng-github.com-thomaspeugeot-thelongbuild/dist/ng-github.com-thomaspeugeot-thelongbuild/browser")))
